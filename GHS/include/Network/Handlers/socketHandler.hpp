...
enum class CMDS : uint8_t {
    GET_ALL = 1, CALIBRATE_TIME, NEW_LOG_RCVD, RELAY_CTRL,
    ...
    ATTACH_RELAYS, SET_TEMPHUM, CLEAR_TEMPHUM_AVG, SET_SOIL,
    ...
    SET_LIGHT_RE_LWR_THAN, SET_LIGHT_RE_GTR_THAN,
    SET_LIGHT_RE_COND_NONE, SET_DARK_VALUE, CLEAR_LIGHT_AVG,
    SET_SPEC_INTEGRATION_TIME, SET_SPEC_GAIN,
